...
export default function LongField(props: any) {
    ...
    return (
        <div>
            ...
            <div className="field">
                <label className="label is-normal">Min Length</label>
                <div className="control field-body">
                    <input className="input" type="number" placeholder="Min Characater Limit" value={item.props.min || ""} onChange={(e) => { handleMin(parseInt(e.target.value)) }} />
                </div>
            </div>
            <div className="field">
                <label className="label is-normal">Max Length</label>
                <div className="control field-body">
                    <input className="input" type="number" placeholder="Max Character Limit" value={item.props.max || ""} onChange={(e) => { handleMax(parseInt(e.target.value)) }} />
                </div>
            </div>
        </div>
    )
