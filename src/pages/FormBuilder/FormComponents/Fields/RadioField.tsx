...
export default function RadioField(props: any) {
    ...
    useEffect(() => {
        if (!item.props.options) {
            setItem((old: any) => {
                ...
                old["props"]["defaultOption"] = 0
                old["props"]["defaultValue"] = opt.value
    ...
    const handleOptionValue = (value: string, index: number) => {
        setItem((old: any) => {
            ...
            if(old.props.defaultOption===index) old.props.defaultValue=old.props.options[index].value
            return old
        })
    }
    ...
    const handleDefaultOption = (index: number) => {
        setItem((old: any) => {
            old = { ...old }
            old.props.defaultOption=index
            old.props.defaultValue=old.props.options[index].value
            return old
        })
    }
    ...
    const handleDelOption = (index: number) => {
        ...
        setItem((old: any) => {
            ...
            if(index===old.props.defaultOption){
            old.props.defaultOption = index-1
            old.props.defaultValue = old.props.options[index-1].value
            }
            return old
        })
    }
